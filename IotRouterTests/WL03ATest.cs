...
public class WL03ATest
{
    [Fact]
    public void TestRealTimeOpenCloseStatus()
    {
        ...
        var rawJson = """
        { "end_device_ids": { "dev_eui": "eui" }, "uplink_message": { "f_port": 2, "received_at": "2024-08-09T14:14:13.093129857Z", "frm_payload": "BAAAAAAAAGgGkzU=", "decoded_payload": "", "rx_metadata": [ {"rssi": "-81" } ] } }
        """;
        ...
        Assert.Equal(0, (int)keyValues["waterStatus"]);
        Assert.Equal(0, (int)keyValues["waterDurationS"]);
        Assert.Equal(0, (int)keyValues["waterTimes"]);
