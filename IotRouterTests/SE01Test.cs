...
public class SE01Test
{
    [Fact]
    public void TestRaw()
    {
        var serviceProviderMock = new Mock<IServiceProvider>();
        var logger = Mock.Of<ILogger<SE01>>();
        ...
        Assert.Equal(36.5m, (decimal)keyValues["soilMoisturePrc"]);
        Assert.Equal(25.52m, (decimal)keyValues["soilTemperature"]);
        Assert.Equal(327m, (decimal)keyValues["soilConductivity"]);
...
""";
    ...
    public void Test()
    {
        ...
        var result = parser.Parse(TheThingsNetworkPacketCreator.Create("deveui", now, -81, "DScMzA5CCfgBRxA="));
