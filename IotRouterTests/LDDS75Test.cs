...
public class LDDS75Test
{
    ...
    public void Test()
    {
        ...
        var rawJson = """
        { "end_device_ids": { "dev_eui": "eui" }, "uplink_message": { "f_port": 2, "received_at": "2024-08-09T14:14:13.093129857Z", "frm_payload": "DQYIuQAAAAE=", "decoded_payload": "", "rx_metadata": [ {"rssi": "-81" } ] } }
        """;
        ...
        Assert.Equal(2233m, (decimal)keyValues["distance"]);
        Assert.Equal(3.334m, (decimal)keyValues["batV"]);
